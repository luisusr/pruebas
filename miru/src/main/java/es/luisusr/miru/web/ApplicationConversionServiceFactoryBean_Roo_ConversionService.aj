...
import es.luisusr.miru.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Tarea, String> ApplicationConversionServiceFactoryBean.getTareaToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<es.luisusr.miru.Tarea, java.lang.String>() {
    ...
    public Converter<Long, Tarea> ApplicationConversionServiceFactoryBean.getIdToTareaConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, es.luisusr.miru.Tarea>() {
            public es.luisusr.miru.Tarea convert(java.lang.Long id) {
    ...
    public Converter<String, Tarea> ApplicationConversionServiceFactoryBean.getStringToTareaConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, es.luisusr.miru.Tarea>() {
            public es.luisusr.miru.Tarea convert(String id) {
